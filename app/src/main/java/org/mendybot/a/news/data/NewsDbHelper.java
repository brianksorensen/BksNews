...
import org.mendybot.a.news.data.NewsContract.NewsEntry;
...
public class NewsDbHelper extends SQLiteOpenHelper {
     ...
     * .db extension.
     */
    public static final String DATABASE_NAME = "freestar_news.db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_NEWS_TABLE =
                ...
                NewsEntry.COLUMN_TIME       + " INTEGER NOT NULL, "                 +

                NewsEntry.COLUMN_TEXT     + " TEXT NOT NULL,"                  +

                NewsEntry.COLUMN_SCORE     + " INTEGER NOT NULL, "                    +
                 ...
                 */
                " UNIQUE (" + NewsEntry._ID + ") ON CONFLICT REPLACE);";

...
import org.mendybot.a.news.utilities.FreestarDateUtils;
...
public class NewsProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, NewsContract.PATH_NEWS, CODE_WEATHER);
         ...
         */
        matcher.addURI(authority, NewsContract.PATH_NEWS + "/#", CODE_WEATHER_WITH_DATE);
    ...
    public boolean onCreate() {
         ...
         * lengthy operations will cause lag in your app. Since NewsDbHelper's constructor is
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        long weatherDate =
                                value.getAsLong(NewsContract.NewsEntry.COLUMN_TIME);
                        if (!FreestarDateUtils.isDateNormalized(weatherDate)) {
     ...
     * override it as NewsProvider extends ContentProvider and getType is an abstract method in

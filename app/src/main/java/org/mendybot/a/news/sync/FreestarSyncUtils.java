...
public class FreestarSyncUtils {
    ...
    private static final String FREESTAR_SYNC_TAG = "freestar-sync";
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        Job syncJob = dispatcher.newJobBuilder()
                .setService(FreestarFirebaseJobService.class)
                .setTag(FREESTAR_SYNC_TAG)
    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        Thread checkForEmpty = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String selectionStatement = NewsContract.NewsEntry
                        .getSqlSelectForNews();
    ...
    public static void startImmediateSync(@NonNull final Context context) {
        Intent intentToSyncImmediately = new Intent(context, FreestarSyncIntentService.class);
